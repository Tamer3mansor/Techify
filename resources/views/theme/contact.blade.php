...
<section class="section-margin--small section-margin">
    @if(session('contact_status'))
        <span class="alert alert-sucess">{{session('contact_status')}}</span>
    @endif
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-lg-3 mb-4 mb-md-0">
                ...
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3><a href="tel:01013699131">01013699131</a></h3>
                        <p>Any Time</p>
                    </div>
                </div>
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3><a href="mailto:support@colorlib.com">TamerMansor371@gmail.com</a></h3>
                        ...
                        <div class="col-lg-7">
                            <div class="form-group">
                                <textarea class="form-control different-control w-100" name="message" id="message"
                                    cols="30" rows="5" placeholder="Enter Message"
